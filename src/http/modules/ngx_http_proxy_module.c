...
// add by zhouxw 20170731 begin/

 
// add by zhouxw 20170731 end
typedef struct {
...
ngx_module_t  ngx_http_proxy_module = {
    ...
    NULL,                                  /* init master */
    NULL,                                  /* init module */
    // add by zhouxw 20170724 begin
    // 将此处定义为审计需要预配置的处理接口
    ngx_http_proxy_init_process,        /* init process */
    // add by zhouxw 20170724 end
    NULL,                                  /* init thread */
    NULL,                                  /* exit thread */
    NULL,                                  /* exit process */
    NULL,                                  /* exit master */
