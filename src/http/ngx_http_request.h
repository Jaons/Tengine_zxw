...
// add by zhouxw 20170704 begin
#if (NGX_HTTP_AUDIT)
typedef struct ngx_http_audit_s  ngx_http_audit_t;

struct ngx_http_audit_s {
    htp_connp_t             *connp;                                                                                                
    htp_cfg_t               *cfg;
    htp_tx_t                *tx;
...
// add by zhouxw 20170704 begin
#if (NGX_HTTP_AUDIT)
    ngx_http_audit_t                  *http_audit_info;
#endif
// add by zhouxw 20170704 end
};
